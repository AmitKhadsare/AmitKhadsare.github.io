...
const Hero = () => {
  ...
  const trustIndicators = [
    ...
    },
    {
      ...
      detail: "1:3 Ratio | 24/7 Overnight Awake Staff",
      iconBg: "bg-emerald-900/80",
      iconFill: "text-emerald-400 fill-emerald-400/50"
    }
  ];
          ...
          >
            <motion.div className="space-y-6" variants={itemVariants}>
              ...
              <p className="text-xl text-stone-300 leading-relaxed max-w-lg mx-auto lg:mx-0">
                Created by Doctors of Physical Therapy, Columbia Care Home combines high-acuity clinical oversight with the calm environment of an intimate 8-resident residential home, a 1:3 caregiver ratio, and 24/7 overnight awake staff.
              </p>
